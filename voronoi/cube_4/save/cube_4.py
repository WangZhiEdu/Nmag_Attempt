...
def my_save(sim):
    print('get_subfield M_H_1\n%s'% str(sim.get_subfield('M_H_1')))
    print('get_subfield_sites M_H_1\n%s' % str(sim.get_subfield_sites('M_H_1')))
    print('get_subfield_average M_H_1\n%s' % str(sim.get_subfield_average('M', 'H_1')))
    print('get_subfield_average_siv M_H_1\n%s' % str(sim.get_subfield_average_siv('M', 'H_1')))
